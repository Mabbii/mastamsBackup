...
// ---    Sun Mar 08 22:08:10 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class Purchase_Lube_OnlyRowImpl extends ViewRowImpl {
    ...
    public static final int ENTITY_PURCHASERATELOG = 3;
    ...
    public static final int PURCHASERATELOGDETAILS = AttributesEnum.PurchaseRateLogDetails.index();
    public static final int PURCHASERATELOGID = AttributesEnum.PurchaseRateLogId.index();
    public static final int PURCHASERATELOGDATE = AttributesEnum.PurchaseRateLogDate.index();
    ...
    public static final int COA_PRODUCT_LUBE_ONLY1 = AttributesEnum.Coa_Product_lube_only1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public Purchase_Lube_OnlyRowImpl() {
    }
    ...
    /**
     * Gets the attribute value for PURCHASE_RATE_LOG_DETAILS using the alias name PurchaseRateLogDetails.
     * @return the PURCHASE_RATE_LOG_DETAILS
     */
    public String getPurchaseRateLogDetails() {
        return (String) getAttributeInternal(PURCHASERATELOGDETAILS);
    }

    /**
     * Sets <code>value</code> as attribute value for PURCHASE_RATE_LOG_DETAILS using the alias name PurchaseRateLogDetails.
     * @param value value to set the PURCHASE_RATE_LOG_DETAILS
     */
    public void setPurchaseRateLogDetails(String value) {
        setAttributeInternal(PURCHASERATELOGDETAILS, value);
    }
    ...
    /**
     * Gets the attribute value for PURCHASE_RATE_LOG_DATE using the alias name PurchaseRateLogDate.
     * @return the PURCHASE_RATE_LOG_DATE
     */
    public Timestamp getPurchaseRateLogDate() {
        return (Timestamp) getAttributeInternal(PURCHASERATELOGDATE);
    }

    /**
     * Sets <code>value</code> as attribute value for PURCHASE_RATE_LOG_DATE using the alias name PurchaseRateLogDate.
     * @param value value to set the PURCHASE_RATE_LOG_DATE
     */
    public void setPurchaseRateLogDate(Timestamp value) {
        setAttributeInternal(PURCHASERATELOGDATE, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> Coa_Product_lube_only1.
     */
    public RowSet getCoa_Product_lube_only1() {
        RowSet rs1 = (RowSet)getAttributeInternal(COA_PRODUCT_LUBE_ONLY1);
                 rs1.executeQuery();
                 return rs1;
     //   return (RowSet) getAttributeInternal(COA_PRODUCT_LUBE_ONLY1);
    }

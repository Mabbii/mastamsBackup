...
// ---    Sun May 31 18:43:36 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ExpensiveRowImpl extends ViewRowImpl {


    public static final int ENTITY_TRANSACTION = 0;
    public static final int ENTITY_BANKTNSTYPE = 1;
    public static final int ENTITY_CHARTOFACCOUNTS = 2;
    public static final int ENTITY_CHARTOFACCOUNTS1 = 3;
    ...
    public static final int COAEXPENSE2 = AttributesEnum.CoaExpense2.index();
    public static final int COA_BANK_PARTY_ACREC_ACPAY1 = AttributesEnum.COA_BANK_PARTY_ACREC_ACPAY1.index();
    public static final int BANKTNSTYPEVIEW1 = AttributesEnum.BankTnsTypeView1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public ExpensiveRowImpl() {
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> CoaExpense2.
     */
    public RowSet getCoaExpense2() {
        RowSet rs = (RowSet)getAttributeInternal(COAEXPENSE2);
         rs.executeQuery();
         return rs;
      //  return (RowSet) getAttributeInternal(COAEXPENSE2);
    }


    /**
     * Gets the view accessor <code>RowSet</code> COA_BANK_PARTY_ACREC_ACPAY1.
     */
    public RowSet getCOA_BANK_PARTY_ACREC_ACPAY1() {
        RowSet rs = (RowSet)getAttributeInternal(COA_BANK_PARTY_ACREC_ACPAY1);
         rs.executeQuery();
         return rs;
       // return (RowSet) getAttributeInternal(COA_BANK_PARTY_ACREC_ACPAY1);
    }
